        ...
        <label for="reason"> Reason:</label>
           <textarea class="form-control" rows="4"  name="reason" id="reason" value="{{old('reason')}}"  required="true"></textarea>
            ...
            @if($loan->loan_status==='reviewed')
              <div class="form-row col-md-12">
                <div class="form-group col-md-12">
                <button class="btn btn-primary col-md-offset-3 col-md-3" style="margin-top: 20px;">Assesses <i class="fa fa-check-circle-o fa-white" style="color:green; font-size:15px;"></i></button>
              </div>
            </div>
            @endif
