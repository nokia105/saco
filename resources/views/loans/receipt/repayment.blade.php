...
<div class="container-fluid" id="print"  style="margin:0 auto; height:70%;">
...
<div class="row">
  ...
  <table class="table table-striped table-bordered">
     ...
     @if(Request::is('payment'))
      <button onclick="printDiv('print')">print<i class="fa fa-print"></i></button>
         @endif
    </html>
